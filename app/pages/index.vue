...
/* ----------------------------------------------------------
   Load front-matter from content/index.md
   ---------------------------------------------------------- */
const { data: page } = await useAsyncData('home-md', () =>
...
/* SEO metadata (fallbacks included) */
const title =
...
const items = ref<TimelineItem[]>([
  ...
  },
  {
    ...
    description:
      'Integrated course modules and dynamic Markdown rendering.',
    icon: 'i-lucide-code'
  },
  {
    date: 'Apr 5, 2025',
...
<template>
  <!-- If you want the MD body somewhere, render it here (optional) -->
